...
class ET_Tracker(Super_model_DP):
    def __init__(
        ...
        # Feature Fusor
        self.feature_fusor = Point_Neck_Mobile_simple_DP(
            num_kernel_list=[64], matrix=True, adj_channel=adj_channel
        )  # stride=8, stride=16
        ...
        self.cls_branch_1 = SeparableConv2d_BNReLU(
            inchannels, outchannels_cls, kernel_size=5, stride=1, padding=padding_5
        )
        self.cls_branch_2 = ExemplarTransformer(
            in_channels=outchannels_cls,
            out_channels=outchannels_cls,
            dw_padding=padding_5,
            e_exemplars=e_exemplars,
            dw_kernel_size=5,
            pw_kernel_size=1,
            sm_normalization=sm_normalization,
            temperature=temperature,
            dropout=dropout,
        )
        self.cls_branch_3 = ExemplarTransformer(
            in_channels=outchannels_cls,
            out_channels=outchannels_cls,
            dw_padding=padding_3,
            e_exemplars=e_exemplars,
            dw_kernel_size=3,
            pw_kernel_size=1,
            sm_normalization=sm_normalization,
        ...
        self.cls_branch_4 = ExemplarTransformer(
            in_channels=outchannels_cls,
            out_channels=outchannels_cls,
            dw_padding=padding_3,
            e_exemplars=e_exemplars,
        ...
        self.cls_branch_5 = ExemplarTransformer(
            in_channels=outchannels_cls,
            out_channels=outchannels_cls,
            dw_padding=padding_3,
            e_exemplars=e_exemplars,
        ...
        self.cls_branch_6 = SeparableConv2d_BNReLU(
            outchannels_cls, outchannels_cls, kernel_size=3, stride=1, padding=padding_3
        )
        self.cls_pred_head = cls_pred_head(inchannels=outchannels_cls)

        self.bbreg_branch_1 = SeparableConv2d_BNReLU(
            inchannels, outchannels_reg, kernel_size=3, stride=1, padding=padding_3
        )
        self.bbreg_branch_2 = ExemplarTransformer(
            in_channels=outchannels_reg,
            out_channels=outchannels_reg,
            dw_padding=padding_3,
            e_exemplars=e_exemplars,
            dw_kernel_size=3,
            pw_kernel_size=1,
        ...
        self.bbreg_branch_3 = ExemplarTransformer(
            in_channels=outchannels_reg,
            out_channels=outchannels_reg,
            dw_padding=padding_3,
            e_exemplars=e_exemplars,
        ...
        self.bbreg_branch_4 = ExemplarTransformer(
            in_channels=outchannels_reg,
            out_channels=outchannels_reg,
            dw_padding=padding_3,
            e_exemplars=e_exemplars,
        ...
        self.bbreg_branch_5 = ExemplarTransformer(
            in_channels=outchannels_reg,
            out_channels=outchannels_reg,
            dw_padding=padding_3,
            e_exemplars=e_exemplars,
        ...
        self.bbreg_branch_6 = ExemplarTransformer(
            in_channels=outchannels_reg,
            out_channels=outchannels_reg,
            dw_padding=padding_5,
            e_exemplars=e_exemplars,
        ...
        self.bbreg_branch_7 = ExemplarTransformer(
            in_channels=outchannels_reg,
            out_channels=outchannels_reg,
            dw_padding=padding_5,
            e_exemplars=e_exemplars,
        ...
        self.bbreg_branch_8 = SeparableConv2d_BNReLU(
            outchannels_reg, outchannels_reg, kernel_size=5, stride=1, padding=padding_5
        )
        self.reg_pred_head = reg_pred_head(
            inchannels=outchannels_reg, linear_reg=linear_reg
        )
    ...
    def initialize(self, model_name, checkpoint_epoch=None):
        ...
        """
        load_lighttrack_model(
            model=self, model_name=model_name, checkpoint_epoch=checkpoint_epoch
        )
